...
const Contact = () => {
  return (
    <div className=" mx-auto py-16 sm:py-24 lg:py-32 stacked-waves-bg">
        ...
        <div className="flex flex-col w-full md:flex-wrap my-5 ">
          ...
          <div className="flex flex-col w-full" id="contact-info">
            <div className="contact-col bg-cyan-800 text-gray-200">
              <div className="contact-col-title flex items-center"> <GoLocation className="mr-2"/>Dirección</div>
              <div className="contact-col-title">Calle asdasd423</div>
            </div>
            <div className="contact-col bg-slate-100">
              <div className="contact-col-title flex items-center"><BsTelephone className="mr-2" />Teléfono</div>
              <div className="contact-col-title">223-1111111</div>
            </div>
            <div className="contact-col bg-cyan-800 text-gray-200">
              <div className="contact-col-title flex items-center"><GoMail className=" mr-2"/>E-mail</div>
