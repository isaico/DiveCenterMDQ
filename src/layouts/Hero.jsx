              ...
              <div class="sm:text-center lg:text-left">
                ...
                <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  ...
                  <div class="mt-3 sm:mt-0 sm:ml-3">
                    ...
                    <LinkTo className={"w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-red-600 bg-indigo-100 hover:bg-cyan-500 hover:text-white md:py-4 md:text-lg md:px-10"} to={"/cursos"} text="Ver Cursos" />
                  </div>
                </div>
              </div>
            </main>
